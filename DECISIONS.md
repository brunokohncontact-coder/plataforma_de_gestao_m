...
- **Nota de concorrência:** número **D276** escolhido como o próximo livre após o D275 (Sessão 280). Se uma
  PR paralela reivindicar D276, renumerar para o próximo livre no merge.
