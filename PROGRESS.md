...
2e. **Hiatos entre shows (secas de agenda)** (entregue na Sessão 267, `/shows/hiatos` + `showGaps` em
   ...
   incluir PROPOSED como "seca provável" à frente (adiado: proposta em aberto ainda pode cair, ruído).
